...
> **⚠️ WARNING: This repository will be archived once the release of the official odbc-scanner extension.**
>
> Please check the official odbc-scanner extension: https://github.com/duckdb/odbc-scanner
